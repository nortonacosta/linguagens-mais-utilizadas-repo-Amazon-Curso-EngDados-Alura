...
class DadosRepositorios:
    ...
    def __init__(self, owner):
        self.owner = owner
        self.api_base_url = 'https://api.github.com' #url base
        self.access_token = 'Seu token' #Token API Github
        self.headers = {'Authorization' : 'Bearer' + self.access_token,
            'X-GitHub-Api-Version' : '2022-11-28'} #dicionário onde junta autorização da API com a versão utilizada
    ...
    def nomes_repos (self, repos_list): 
        '''
        Selecionando apenas os nomes dos repositorios
        '''
        repo_names=[] 
    ...
    def nomes_linguagens (self, repos_list):
        '''
        Selecionando as linguagens de programação
        '''
        repo_languages=[]
        for page in repos_list:
            for repo in page:
...
# Salvando os dados 
ling_mais_usadas_amzn.to_csv('venv/dados/linguagens_amzn.csv')
ling_mais_usadas_netflix.to_csv('venv/dados/linguagens_netflix.csv')
ling_mais_usadas_spotify.to_csv('venv/dados/linguagens_spotify.csv')
